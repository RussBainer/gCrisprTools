...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=20, fig.width=10, fig.cap="Figure 2: gRNA Density Before and After Filtering with the Default Parameters"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10, fig.cap= "Figure 3: Raw gRNA Count Densities"}
ct.rawCountDensities(eset = filt.eset, sampleKey = params$sampleKey)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10, fig.cap="Figure 4: GC content and gRNA Abundance"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10, fig.cap= "Figure 5: Ranked gRNA Distributions by Replicate"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10, fig.cap= "Figure 6: Per-Replicate gRNA Cumulative Distributions"}
ct.guideCDF(
  eset = filt.eset,
  sampleKey = params$sampleKey,
  plotType = "Target",
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10, fig.cap="Figure 7: Nontargeting Control Behavior Before and After Median Scaling"}
tryCatch(
  ct.viewControls(
    eset = filt.eset,
    annotation = params$annotation,
