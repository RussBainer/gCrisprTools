...
---
### Example Vanilla Workflow
This is an example workflow for processing a pooled CRISPR-based screen using the provided sample data. See the various manpages for additional visualization options and algorithmic details. If you are considering integrating the results of many screens or scren contrasts, refer to the `Contrast Comparisons` vignette. 
